...
/**
 * Schema for OpenID Connect authentication request parameters used in federation flows.
 */
export const oidcAuthenticationRequestSchema = z.object({
  /**
...
/**
 * Type definition for OidcAuthenticationRequest.
 */
export type OidcAuthenticationRequest = z.infer<typeof oidcAuthenticationRequestSchema>;
